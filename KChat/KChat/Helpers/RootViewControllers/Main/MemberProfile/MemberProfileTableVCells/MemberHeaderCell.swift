...
class MemberProfileHeaderViewTable: UITableViewHeaderFooterView {
    ...
    private lazy var messageToMember = CustomButton(title: ProfileConstans.messageToMember, titleColor: .white, backgroundButtonColor: UIColor(red: 1.00, green: 0.62, blue: 0.27, alpha: 1.00), cornerRadius: 10, useShadow: false, action: {self.buttonAction()})
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate ([
            ...
            self.avatarImage.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.2),
            self.avatarImage.heightAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.2),
            ...
            self.birthdayLabel.widthAnchor.constraint(equalToConstant: 100),
            ...
            self.cityIcon.topAnchor.constraint(equalTo: self.topAnchor, constant: 87),
            ...
            self.messageToMember.topAnchor.constraint(equalTo: self.avatarImage.bottomAnchor, constant: 16),
            ...
            self.messageToMember.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -9),
