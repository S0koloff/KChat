...
protocol MainPostTableViewCellProtocol {
    func openComments()
    func tapToLike()
...
class PostsTableViewCell: UITableViewCell {
    ...
    var delegate: MainPostTableViewCellProtocol!
    var id = ""
    var likedBool = false
   ...
   func setup(with post: PostModel) {
       ...
       self.myImageView.image = UIImage(named: "\(post.postImage)")
    ...
    func changeAvatarAndId(user: MemberModel, post: PostModel ) {
