...
class InfoSettingsViewController: UIViewController {
    ...
    private func setupInfoText() {
        self.nameTextField.text = UserDefaultSettings.userModel.name
        self.surnameTextField.text = UserDefaultSettings.userModel.surname
        self.birthdayTextField.text = UserDefaultSettings.userModel.birthday
        self.cityTextField.text = UserDefaultSettings.userModel.city
    }
        ...
        let firstAction = UIAlertAction(title: ProfileConstans.saveAlertYesButton, style: .default) { _ in
            ...
            if self.nameTextField.text?.isValidId == false {
                ...
                let updateUserData = UserModel(
                    ...
                    name: self.nameTextField.text ?? UserDefaultSettings.userModel.name,
                    surname: self.surnameTextField.text ?? UserDefaultSettings.userModel.surname,
                    status: UserDefaultSettings.userModel.status,
                    birthday: self.birthdayTextField.text ?? UserDefaultSettings.userModel.birthday,
                    city: self.cityTextField.text ?? UserDefaultSettings.userModel.city)
