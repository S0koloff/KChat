...
class CommentViewController: UIViewController, CommentsHeaderProtocol {
    ...
    @objc private func addCommentAction(_ sender: UITapGestureRecognizer) {
        ...
        realmService.createComment(postId: postID,
                                   avatar: (UserDefaultSettings.userModel.avatar.pngData() ?? UIImage(named: "newProfileAvatar")?.pngData())!,
                                   text: commentTextField.text ?? "",
                                   date: "22.02",
                                   likes: 0,
                                   userId: UserDefaultSettings.userModel.id)
...
extension CommentViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        print("ARRAYCOUNT:",commentsArray.count)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setup(with: commentsArray[indexPath.item])
