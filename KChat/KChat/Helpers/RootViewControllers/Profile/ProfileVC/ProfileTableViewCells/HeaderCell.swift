...
class ProfileHeaderViewTable: UITableViewHeaderFooterView {
    ...
    private lazy var setProfileButton = CustomButton(title: ProfileConstans.settingsButtonTitle, titleColor: .white, backgroundButtonColor: UIColor(red: 1.00, green: 0.62, blue: 0.27, alpha: 1.00), cornerRadius: 10, useShadow: false, action: {self.buttonAction()})
    
    private lazy var setSaveButton = CustomButton(title: ProfileConstans.statusButtonSave, titleColor: .white, backgroundButtonColor: UIColor(red: 1.00, green: 0.62, blue: 0.27, alpha: 1.00), cornerRadius: 10, useShadow: false, action: {self.saveButtonAction()})
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate ([
            ...
            self.setProfileButton.topAnchor.constraint(equalTo: self.avatarImage.bottomAnchor, constant: 16),
            ...
            self.setProfileButton.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -9),
            
            self.setSaveButton.topAnchor.constraint(equalTo: self.avatarImage.bottomAnchor, constant: 16),
            ...
            self.setSaveButton.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -9)
        ])
        
    }
    
    func setup(with profile: UserModel) {
        self.avatarImage.image = profile.avatar
    ...
    @objc private func buttonAction() {
        ...
        self.setProfileButton.isHidden = true
    ...
    @objc private func saveButtonAction() {
        ...
        self.setSaveButton.isHidden = true
        self.setProfileButton.isHidden = false
        self.delegate.statusUpdate(text: self.statusTextField.text ?? "")
    }
