...
class LoginViewController: UIViewController {
    ...
    private lazy var regButton = CustomButton(title: LoginConstans.registrationButtonTitle, titleColor: .white, backgroundButtonColor: UIColor(red: 0.17, green: 0.22, blue: 0.25, alpha: 1.00), cornerRadius: 10, useShadow: false, action: { self.regButtonAction() })
